...
export const CloudIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M20 16.5c0-3.59-2.686-6.5-6-6.5-3.314 0-6 2.91-6 6.5" />
    <path d="M14.5 10c0-3.037-2.463-5.5-5.5-5.5S3.5 6.963 3.5 10" />
    <path d="M20.5 10c0 3.037-2.463 5.5-5.5 5.5" />
  </svg>
);
